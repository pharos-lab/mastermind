<template>
    <div class="flex flex-col h-screen text-slate-800 bg-slate-50">
        ...
        <div class="container mx-auto mastermind flex flex-col lg:grid lg:grid-cols-3 lg:grid-rows-[auto_auto_1fr] gap-4 p-4 lg:p-6 grow">
            <Info 
